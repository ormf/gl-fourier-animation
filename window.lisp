...
(defmethod glut:display-window :after ((w gl-window))
  "setup function before window creation"
...
(defmethod glut:close ((window gl-window))
...
(defmethod glut:idle ((window gl-window))
  (glut:post-redisplay))

(defmethod glut:mouse ((window gl-window) button state x y)
...
(defmethod glut:reshape ((window gl-window) width height)
...
(defmethod glut:keyboard ((window gl-window) key x y)
